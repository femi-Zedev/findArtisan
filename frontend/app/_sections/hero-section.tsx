...
export function HeroSection() {
  ...
  return (
    <section className="w-full px-10 py-6 sm:py-10 sm:px-6 lg:px-8 mt-14">
      <div className="mx-auto max-w-6xl text-center space-y-6  sm:space-y-10">
        {/* Main Headline */}
        <h1 className="font-extrabold leading-none tracking-tighter text-gray-900 dark:text-white text-5xl lg:text-6xl">
          Trouve le bon <br className="block sm:hidden" /> <AnimatedProfession /> <br /> près de{" "}
          chez toi
        </h1>

        {/* Subtitle */}
        <p className="mb-10 text-base sm:text-lg text-gray-600 dark:text-gray-300 sm:text-xl max-w-2xl mx-auto">
